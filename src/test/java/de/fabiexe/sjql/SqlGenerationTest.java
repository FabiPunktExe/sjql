...
public class SqlGenerationTest {
    ...
    public void testLogicalOperators() {
        ...
        assertEquals("(name) != (?)", SQLUtil.buildSql(Coffee.NAME.neq("Espresso")).getKey());
    ...
    public void testLogicalOperatorsWithoutPlaceholders() {
        ...
        assertEquals("(name) != ('Espresso')", SQLUtil.buildSqlWithoutPlaceholders(Coffee.NAME.neq("Espresso")));
